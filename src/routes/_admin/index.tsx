...
import { Users, Eye, DollarSign, Percent, TrendingUp } from "lucide-react";
import {
...
function AdminOverview() {
  return (
    <AdminShell title="Overview" subtitle="Real-time growth, engagement and monetization across Admiralty.">
        ...
        <div className="glass rounded-3xl p-5">
          ...
          <div className="mt-2 flex items-center gap-4">
            <div className="h-40 w-40">
              <ResponsiveContainer>
                <PieChart>
                  <Pie data={revenueSplit} dataKey="value" innerRadius={42} outerRadius={66} paddingAngle={3} stroke="none">
