...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Boogle" },
      { name: "description", content: "Boogle is a premium short-video and live-streaming community." },
      { property: "og:title", content: "Boogle" },
      { name: "twitter:title", content: "Boogle" },
      { property: "og:description", content: "Boogle is a premium short-video and live-streaming community." },
      { name: "twitter:description", content: "Boogle is a premium short-video and live-streaming community." },
