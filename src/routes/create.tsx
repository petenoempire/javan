...
import { X, RotateCw, Circle, Square, Check, Loader2, Image as ImageIcon, Dog, Sparkles, MonitorPlay, Camera } from "lucide-react";
    ...
    return (
      <MobileShell>
        <div className="flex min-h-[60dvh] flex-col items-center justify-center text-center px-8">
          ...
          <Link
            to="/auth"
            className="w-full bg-gradient-primary py-4 rounded-2xl text-sm font-bold text-white shadow-glow"
          >
            Sign In to Create
          </Link>
        </div>
