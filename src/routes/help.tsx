        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
           <div className="lg:col-span-4 space-y-6">
              <div className="glass p-8 rounded-[2rem] border border-white/5 bg-gradient-to-br from-cyan-500/5 to-transparent">
                 <h2 className="font-bold mb-4">Contact Support</h2>
                 <div className="space-y-4">
                    <Link to="/help/chat" className="flex items-center gap-3 p-4 rounded-2xl bg-white/5 hover:bg-white/10 transition-all border border-white/5">
                       <MessageCircle className="h-5 w-5 text-fuchsia-400" />
                       <span className="text-sm font-bold">Live Chat</span>
                    </Link>
                    <Link to="/report-problem" className="flex items-center gap-3 p-4 rounded-2xl bg-white/5 hover:bg-white/10 transition-all border border-white/5">
              ...
              <div className="glass p-8 rounded-[2rem] border border-white/5">
                 ...
                 <div className="relative">
                    ...
                    <input 
                       ...
                       className="w-full bg-white/5 border border-white/10 rounded-xl py-3 pl-12 pr-4 text-sm outline-none focus:border-cyan-500/50"
                    />
                 </div>
              </div>
           </div>
                 ...
                 {filteredFaqs.map((faq, i) => (
                    <div key={i} className="glass rounded-2xl border border-white/5 overflow-hidden">
                       ...
                       >
                          ...
                          <ChevronDown className={`h-5 w-5 text-white/20 transition-transform ${openIndex === i ? "rotate-180" : ""}`} />
                       </button>
                       {openIndex === i && (
