...
const RESOURCES = [
  { title: "Monetizing your content on Javan", body: "Javan has multiple programs designed to reward what you create — and the right fit depends on your style.", views: "Official Guide", hue: "from-yellow-400 to-orange-500" },
  { title: "Creator Monetization Center", body: "Meet the Creator Monetization Center—your all-in-one hub for getting rewarded on Javan.", views: "Creator Hub", hue: "from-rose-500 to-red-700" },
  { title: "Effect Creator Rewards", body: "Wondered what Javan's Effect Creator Rewards is? It's an awesome way to get paid for your effects.", views: "Rewards Program", hue: "from-indigo-500 to-violet-700" },
];
