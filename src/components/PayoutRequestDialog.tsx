  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="bg-[#020210] border-white/10 text-white max-w-md rounded-[2.5rem] shadow-glow">
        <DialogHeader>
          <DialogTitle className="text-2xl font-black text-chrome tracking-tight">Request Payout</DialogTitle>
          <DialogDescription className="text-white/40">Securely withdraw your creator earnings to your preferred account.</DialogDescription>
        </DialogHeader>
        <div className="space-y-4">
          ...
          <button
            ...
            disabled={!canSubmit}
            className="w-full rounded-2xl bg-emerald-500 py-4 font-black text-black shadow-glow disabled:opacity-50 active:scale-95 transition-all hover:bg-emerald-400"
          >
