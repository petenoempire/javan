        ...
        <>
          ...
          <motion.div initial={{ y: "100%" }} animate={{ y: 0 }} exit={{ y: "100%" }}
            ...
            <div className="flex items-center justify-between p-5 pb-3">
              ...
              <button onClick={onClose} aria-label="Close comments" className="rounded-full p-1 hover:bg-muted"><X className="h-5 w-5" /></button>
            </div>
            ...
            <div className="border-t border-border p-4">
              <div className="glass flex items-center gap-2 rounded-full px-4 py-2">
                ...
                />
                <button onClick={send} aria-label="Send comment" className="bg-gradient-primary rounded-full p-2">
