        ...
        <>
          ...
          <motion.div initial={{ y: "100%" }} animate={{ y: 0 }} exit={{ y: "100%" }}
            ...
            <div className="flex items-center justify-between p-6 border-b border-white/5">
              <h3 className="font-display text-lg font-black text-chrome">{comments.length} comments</h3>
              <button onClick={onClose} aria-label="Close comments" className="rounded-xl p-2 hover:bg-white/5 transition-colors"><X className="h-5 w-5" /></button>
            </div>
            ...
            <div className="border-t border-border p-4">
              <div className="glass flex items-center gap-2 rounded-full px-4 py-2">
                ...
                />
                <button onClick={send} aria-label="Send comment" className="bg-gradient-primary rounded-xl p-2.5 shadow-glow active:scale-90 transition-transform">
