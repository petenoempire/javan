        ...
        <>
          ...
          <motion.div initial={{ y: "100%" }} animate={{ y: 0 }} exit={{ y: "100%" }}
            ...
            <button onClick={submit} disabled={!reason || submitting}
              className="bg-gradient-primary mt-4 w-full rounded-2xl py-4 text-sm font-black text-white shadow-glow disabled:opacity-50 active:scale-95 transition-all">
